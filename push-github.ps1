...
foreach ($file in @("style.css", "hr-core.js", "dev-banner.js", "face-core.js", "dashboard.js", "english-input.js", "attendance-gps.js", "attendance-camera.js", "attendance-flow.js")) {
