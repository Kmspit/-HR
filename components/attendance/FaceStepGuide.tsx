...
export const REGISTER_GUIDE_STEPS: FaceGuideStep[] = [
  ...
  {
    title: 'หน้าตรง',
    body: 'มองตรงกล้อง — ระบบจับภาพให้อัตโนมัติเมื่อตรงท่า',
    tip: 'ถอดแว่น/หมวกที่บังใบหน้า',
  },
  {
    title: 'หันซ้าย',
    body: 'หันศีรษะช้า ๆ ไปทางซ้ายของคุณ — รอจนระบบขึ้นว่าผ่าน',
    tip: 'ไม่ต้องหันจนสุด',
  },
  {
    title: 'หันขวา',
    body: 'หันศีรษะช้า ๆ ไปทางขวาของคุณ — ครบแล้วบันทึกอัตโนมัติ',
    tip: 'ทำช้า ๆ คงท่าไว้สักครู่',
  },
]
