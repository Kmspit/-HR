...
const CHIP_COLORS: Record<NonNullable<StatChip['color']>, string> = {
  blue:   'bg-green-50 text-green-700 border-green-200 dark:bg-green-500/10 dark:text-green-400 dark:border-green-500/20',
  ...
  return (
    <div
      className={cn(
        ...
        'bg-white dark:bg-[#070b14] md:bg-white/80 md:dark:bg-transparent md:backdrop-blur-sm',
