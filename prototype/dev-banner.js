...
;(function () {
  ...
  el.innerHTML =
    ...
    ' · demo <code style="background:rgba(0,0,0,.3);padding:2px 6px;border-radius:4px">employee@demo.com</code> / <code style="background:rgba(0,0,0,.3);padding:2px 6px;border-radius:4px">demo1234</code>'
  el.style.cssText =
