    ...
    <div className="flex flex-col">
      ...
      <div className="p-5 md:p-6 space-y-6">
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <Link
            href="/approvals"
            className="rounded-2xl bg-white dark:bg-[#0f172a] border border-orange-200 dark:border-orange-900/50 shadow-none p-4 transition-none"
          >
          ...
          <Link
            href="/notifications"
            className="rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-none p-4"
          >
        ...
        <div className="rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-none p-5 md:p-6">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
            {[
              { href: '/approvals', label: 'ศูนย์อนุมัติ', sub: inbox.total > 0 ? `${inbox.total} รอดำเนินการ` : 'ไม่มีค้าง', iconClass: 'bg-orange-600 border-orange-700', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
              ...
              <Link
                key={a.href}
                href={a.href}
                className="flex flex-col items-center gap-2.5 rounded-xl p-4 text-center border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a] transition-none shadow-none"
              >
